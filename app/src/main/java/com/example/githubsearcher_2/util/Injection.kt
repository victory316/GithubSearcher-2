...
import com.example.githubsearcher_2.data.source.local.TasksLocalDataSource
...
object Injection {
    ...
    fun provideTasksRepository(context: Context): GithubRepository {
        ...
        return GithubRepository.getInstance(FakeTasksRemoteDataSource,
                TasksLocalDataSource.getInstance(AppExecutors(), database!!.githubDao()))
    }
}
