...
class UserDataAdapter(private val mArticles: List<GithubUserData>) : RecyclerView.Adapter<UserDataAdapter.BindingHolder>() {
    ...
    override fun onBindViewHolder(holder: BindingHolder, position: Int) {
        ...
        binding.viewModel = MainViewModel(mArticles[position])
    }
